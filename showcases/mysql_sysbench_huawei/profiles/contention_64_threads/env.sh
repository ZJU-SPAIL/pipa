...
# --- 压测场景特化 ---
export SYSBENCH_LUA="oltp_update_non_index"
export INNODB_FLUSH_TRX="1"   # 增加磁盘 IO 同步等待
export INNODB_SYNC_BINLOG="1"

# --- 关键配置：解除 I/O 枷锁 (指南 P24) ---
export INNODB_FLUSH_METHOD="O_DIRECT"
# 华为指南未强制要求双一，为了跑分通常宽松处理，或者根据你要测的场景定
# export INNODB_FLUSH_TRX="0" # Moved to 压测场景特化
# export INNODB_SYNC_BINLOG="0" # Moved to 压测场景特化
